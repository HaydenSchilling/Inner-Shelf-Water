...
#try GLM with Gamma
M2<- glm(Biomass~Temp+fluorescence+GA_depth2+Dbin+site2,
...
M4 <- gam(Biomass~s(Temp)+s(fluorescence)+s(GA_depth2)+Dbin+site2,
...
#try Gaussian
M5 <- gam(Biomass~s(Temp)+s(fluorescence)+s(GA_depth2)+Dbin+site2,
...
#M6<- glm(Biomass~Temp+fluorescence+GA_depth2+site2,Dbin,
...
par(mfrow=c(2,2))
visreg(M7, "Temp", by="Dbin", overlay=T, scale="response", ylim = c(0, 10000))
visreg(M7, "fluorescence", by="Dbin", overlay=T, scale="response", ylim = c(0, 10000))
...
par(mfrow=c(2,2))
visreg(M8, "Temp", by="Dbin", overlay=T, scale="response", ylim = c(0, 10000))
visreg(M8, "fluorescence", by="Dbin", overlay=T, scale="response", ylim = c(0, 10000))
visreg(M8, "GA_depth2", scale="response")
visreg(M8, "site2", scale="response")
visreg(M8, "Dbin", scale="response")

par(mfrow=c(1,1))
visreg(M8, "Temp", overlay=T, scale="response", ylim = c(0, 10000))
visreg(M8, "fluorescence", overlay=T, scale="response", ylim = c(0, 10000))
...
par(mfrow=c(2,2))
visreg(M9, "Temp", by="Dbin", overlay=T, scale="response", ylim = c(0, 10000))
visreg(M9, "fluorescence", by="Dbin", overlay=T, scale="response", ylim = c(0, 10000))
